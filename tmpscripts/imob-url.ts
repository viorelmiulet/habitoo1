...
const s = await getImobiliareSession({ admin: db, organizationId: c.organization_id, username: c.external_account_id, credential: c.credential ?? c.portal_credential });
