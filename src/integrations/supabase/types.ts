...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      properties: {
        Row: {
          ...
          pre_archive_status: Database["public"]["Enums"]["property_status"] | null;
          price: number | null;
    ...
    Enums: {
      activity_kind: "call" | "meeting" | "viewing" | "task" | "email" | "followup" | "note";
      activity_status: "planned" | "done" | "cancelled";
      app_role: "superadmin" | "agency_admin" | "agent";
      contact_type:
        "owner" | "buyer" | "tenant" | "investor" | "agent" | "partner" | "developer" | "company";
      lead_stage:
        | "new"
        | "contacted"
        | "qualified"
        ...
        | "won"
        | "lost";
      org_status: "active" | "trial" | "suspended" | "cancelled" | "pending_approval";
      property_status:
        | "draft"
        | "active"
        | "reserved"
