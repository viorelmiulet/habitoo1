    ...
    Tables: {
      ...
      contract_signature_tokens: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "contract_signature_tokens_party_id_fkey"
            columns: ["party_id"]
            isOneToOne: false
      ...
      contract_templates: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "contract_templates_source_template_id_fkey"
      ...
      organization_ai_features: {
        ...
        Relationships: [
          {
            foreignKeyName: "organization_ai_features_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      portal_slot_allocations: {
        ...
        Relationships: [
          {
            foreignKeyName: "portal_slot_allocations_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      portal_slot_limits: {
        ...
        Relationships: [
          {
            foreignKeyName: "portal_slot_limits_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
