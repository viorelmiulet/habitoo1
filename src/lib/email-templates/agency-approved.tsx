...
export const AgencyApprovedEmail = ({
  ...
  >
    ...
    <Text style={paragraph}>
      Cererea de înscriere a agenției <strong>{agencyName}</strong> a fost verificată și aprobată.
      Contul tău de administrator este activ, iar agenția este pregătită în {siteName}.
    </Text>
    <Text style={strongText}>Poți intra direct în aplicație și începe să lucrezi.</Text>
    <Text style={paragraph}>
      Dacă sesiunea a expirat, te rugăm să te autentifici din nou cu emailul și parola contului tău.
    </Text>
