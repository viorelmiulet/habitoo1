...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  ...
  >
    ...
    <Text style={paragraph}>
      Am primit o cerere de resetare a parolei pentru contul tău din <strong>{siteName}</strong>.
    </Text>
    <Text style={strongText}>
      Apasă butonul de mai jos ca să îți alegi o parolă nouă. Linkul este valabil o perioadă
      limitată.
    </Text>
