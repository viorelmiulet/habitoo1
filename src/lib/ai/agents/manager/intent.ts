...
const PROSPECTING = ["prospect", "gaseste anunturi", "surse externe", "anunturi noi", "proprietati noi", "proprietatile noi", "anunturile noi", "piata externa", "gaseste proprietati", "gaseste proprietatile noi", "proprietari care vand", "lead noi", "leaduri noi", "oportunitati noi"];
