...
export async function seedQaData(admin: Admin, orgId: string, users: Ids, actorId: string): Promise<SeedSummary> {
  ...
  const requests: TablesInsert<"requests">[] = [
    ...
    { id: R.ioana, organization_id: org, contact_id: C.ioana, kind: "buy", title: "2–3 camere, Sector 6 (Militari / Drumul Taberei / Crângași), până la 120.000 EUR", property_type: "apartment", budget_min: 80000, budget_max: 120000, currency: "EUR", cities: ["București"], areas: ["Militari", "Drumul Taberei", "Crângași"], rooms_min: 2, rooms_max: 3, surface_min: 50, features: ["Balcon"], wants_balcony: true, priority: "normal", status: "active", source: "Facebook", notes: "Prima locuință, flexibilă pe zonă în vestul orașului.", assigned_to: A.radu, created_by: A.radu, created_at: iso(ago(24)) },
