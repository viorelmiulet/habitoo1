...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-control text-sm font-bold cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:border-transparent disabled:bg-muted disabled:text-faint [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "border border-primary bg-primary text-primary-foreground hover:bg-gold-dark hover:text-surface",
        primary: "border border-primary bg-primary text-primary-foreground hover:bg-gold-dark hover:text-surface",
        destructive: "border border-[#D8B9B3] bg-surface text-destructive hover:bg-[#F6E4E1]",
        danger: "border border-[#D8B9B3] bg-surface text-destructive hover:bg-[#F6E4E1]",
